...
// ====================================================================================================================
const GLenum Shader::cvTypeToGLFormat(const int _cvtype) {
  if (_cvtype == CV_8UC1)
...
// ====================================================================================================================
void Shader::SetupTexture(const GLenum _texture, GLuint* _ptrTextures, const cv::Mat& _frame, const GLint _internalFormat, const GLsizei _n, const GLenum _target, const GLint _level, const GLint _border) {
  return SetupTexture(_texture, _ptrTextures, _frame.cols, _frame.rows, _frame.data, _internalFormat, _n, _target, _level, _border, cvTypeToGLFormat(_frame.type()));
}
// ====================================================================================================================
...
// ====================================================================================================================
void Shader::UpdateTexture(const GLenum _texture, GLuint* _ptrTextures, const cv::Mat& _frame, const GLint _internalFormat, const GLsizei _n, const GLenum _target, const GLint _level, const GLint _border) {
  return UpdateTexture(_texture, _ptrTextures, _frame.cols, _frame.rows, _frame.data, _internalFormat, _n, _target, _level, _border, cvTypeToGLFormat(_frame.type()));
}
// ====================================================================================================================
