...
public:
  ...
  void SetupTexture(const GLenum _texture, GLuint* _ptrTextures, const cv::Mat& _frame, const GLint _internalFormat=GL_RED, const GLsizei _n=1, const GLenum _target=GL_TEXTURE_2D, const GLint _level=0, const GLint _border=0);
  ...
  void UpdateTexture(const GLenum _texture, GLuint* _ptrTextures, const cv::Mat& _ptrFrame, const GLint _internalFormat=GL_RED, const GLsizei _n=1, const GLenum _target=GL_TEXTURE_2D, const GLint _level=0, const GLint _border=0);
