...
// ====================================================================================================================
// ---- constructor ---------------------------------------------------------------------------------------------------
ImGuiCanvasShape::ImGuiCanvasShape(std::string _label, const ImVec2 _center, const ImGuiCanvasShapeType _type, const std::initializer_list<float> _parameters, const ImGuiCanvasClip _clip, const bool _drawCtrls) : m_visible(true), m_label(_label), m_index(ImGuiCanvasShape::nextIndex++), m_type(_type), m_center(_center), m_clip(_clip), m_drawCtrls(_drawCtrls) {
  switch (m_type) {
...
ImGuiCanvasShape::ImGuiCanvasShape(const ImGuiCanvasShape& _source) : m_label(_source.getLabel()), m_index(_source.getIndex()), m_type(_source.getType()), m_center(_source.getCenter()), m_ctrlPoints(_source.getCtrlPoints()), m_clip(_source.getClip()), m_drawCtrls(_source.getDrawCtrls()) {}
